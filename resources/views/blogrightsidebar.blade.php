        ...
        <div id="blog" class="blog-area pt-120 pb-110">
            <div class="container">
                <div class="row">
                    <div class="col-xl-8">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="blog-wrapper blue-blog mb-50 wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, incididunt tetur sicing incididunt , sed tempor ut labore et dolore magna aliqua enim ad.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6">
                    ...
                    <div class="col-xl-4 sidebar-blog pl-30">
                        <div class="widget">
